...
定义 uni-admin 系统的数据验证规范，包括 Zod Schema 共享定义、Class-Validator DTO 标准化和 VeeValidate 前端集成，确保前后端数据校验规则的一致性和类型安全。

**Scope**: 覆盖 Zod Schema 定义、class-validator 装饰器使用、vee-validate 集成。
