...
##### Scenario: Stage 3 开始前设置 Loading 状态 (🆕 页面加载过渡集成)
...
##### Scenario: Stage 3 成功完成清除 Loading 状态 (🆕 页面加载过渡集成)
...
##### Scenario: Stage 3 失败时清除 Loading 状态并重定向 (🆕 页面加载过渡集成)
...
##### Scenario: 动态路由已加载时跳过 Loading 控制 (🆕 页面加载过渡集成)
